...
class _BodyPageState extends State<BodyPage> {
  ...
  void initState() {
    ...
    _currentSliderValueCM = 48.7;
    _currentSliderValueIN = 19.2;
    _talla = "2XS";
  }
  ...
  void _mostrarResultado(BuildContext context) {
    if (_dropdownValue == "CM") {
      if (_currentSliderValueCM >= 48.7 && _currentSliderValueCM <= 52.7) {
        _talla = "2XS";
        ...
        _talla = "XL";
          ...
          _currentSliderValueCM <= 76.8) {
        _talla = "2XL";
      } else if (_currentSliderValueCM >= 76.9 &&
          _currentSliderValueCM <= 79.7) {
        _talla = "3XL";
      }
    }

    if (_dropdownValue == "IN") {
      if (_currentSliderValueIN >= 19.2 && _currentSliderValueIN <= 20.7) {
        _talla = "2XS";
        ...
        _talla = "XL";
          ...
          _currentSliderValueIN <= 30.2) {
        _talla = "2XL";
      } else if (_currentSliderValueIN >= 30.3 &&
